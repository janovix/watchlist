...
export const translations = {
	pt: {
		...
		confidenceRequiresVerification: "Requer verificação",
		sourceAi: "Inteligência Artificial",
		sourceWatchlist: "Lista de vigilância",
		sourceGk: "Grok (IA Externa)",
	...
	es: {
		...
		confidenceRequiresVerification: "Requiere verificación",
		sourceAi: "Inteligencia Artificial",
		sourceWatchlist: "Lista de vigilancia",
		sourceGk: "Grok (IA Externa)",
	...
	en: {
		...
		confidenceRequiresVerification: "Requires verification",
		sourceAi: "Artificial Intelligence",
		sourceWatchlist: "Watchlist",
		sourceGk: "Grok (External AI)",
